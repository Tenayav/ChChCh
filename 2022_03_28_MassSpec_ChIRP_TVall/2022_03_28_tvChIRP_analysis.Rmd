...
significant_intensities_genes <- list(genes_ChIRP_Mar2022 = sort(quick_sig_genes_intensities_Mar2022$gene), genes_SucGrad_Mar2022= sort(quick_sig_genes_intensities_SucGrad_Mar2022$gene))
pdf("VennDiagram_SigGenes_ChIRPMar2022_SucGradMar2022.pdf")
ggvenn(genes, c("genes_ChIRP_Mar2022","genes_SucGrad_Mar2022"))
dev.off()

significant_intensities_genes <- list(genes_ChIRP_Mar_Jan2022 = sort(quick_sig_genes_intensities_Mar2022withJan2022$gene), genes_SucGrad_Mar2022= sort(quick_sig_genes_intensities_SucGrad_Mar2022$gene))
pdf("VennDiagram_SigGenes_ChIRPMarJan2022_SucGradMar2022.pdf")
ggvenn(genes, c("genes_ChIRP_Mar_Jan2022","genes_SucGrad_Mar2022"))
dev.off()
