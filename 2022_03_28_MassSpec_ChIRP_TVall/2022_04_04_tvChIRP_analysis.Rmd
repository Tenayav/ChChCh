...
ggplot(mm_Fedepulldown, aes(x=variable, y=value, fill=genotype_Fedepulldown))+geom_bar(stat="identity", position=position_dodge())+ scale_fill_manual(values=c('#808080','#BB2526','#E63954'))+ ggtitle("Homebrew Firre ChIRP Pulldown Efficiency and Specificity") +
