...
#sum of each row
Intensities_A <- Intensities_A[] + 1 
Intensities_2 <- Intensities_A %>% mutate(intensities_ratio1 = (r2_wt_oe_intensity.50ng/r2_ko_oe_intensity.50ng), intensities_ratio2=(r3_wt_oe_intensity.50ng/r3_ko_oe_intensity.50ng), intensities_ratio3 = (r4_ko_oe_intensity.50ng/mean(c())))
