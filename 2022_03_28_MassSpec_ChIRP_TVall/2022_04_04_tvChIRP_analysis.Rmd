...
grViz(diagram = "digraph flowchart {
      ...
      tab17 -> {tab18 tab19 tab20 tab21 tab22}
      }
      ...
      [8]: '3 WT and 0 KO [23 Genes]'
      [9]: '2 WT and 0 KO [30 Genes]'
      [10]: '3 WT and 1 KO [19 Genes]'
      [11]: '3 WT and 0 KO [5 Genes]'
      [12]: '2 WT and 0 KO [8 Genes]'
      [13]: '3 WT and 1 KO [4 Genes]'
      [14]: 'Combine 3WT and 0KO Genes from 50ng and 100ng'
      [15]: 'Combine 2WT and 0KO Genes from 50ng and 100ng'
      [16]: 'Combine 3WT and 1KO Genes from 50ng and 100ng'
      [17]: 'Expand Comparison to Other Datasets'
      [18]: '50ng&100ng combined ratios and pvalues'
      [19]: 'Sucrose Gradient Ratios and KO checks'
      [20]: 'Odd and Even Ratios and KO Checks from Jan2022 TV'
      [21]: 'Odd and Even Ratios from Jan2022 Fede Data for both WT:KO and WT2h:KO'
      [22]: 'Michaels RNA seq Ratios and Padjvalues'
      ")
...
alldata_nofilter3 <- full_join(alldata_nofilter1, Intensities_Jan2022_FA, by=c("gene.combinedMarChIRP" = "gene.Fede_Jan2022"))
all_data_nofilter_final <- full_join(alldata_nofilter1, Michael_RNASeq_WT_v_KO, by=c("gene.combinedMarChIRP" = "gene_name"))
