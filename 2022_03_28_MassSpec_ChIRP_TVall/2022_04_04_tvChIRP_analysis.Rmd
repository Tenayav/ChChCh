...
#pulldown efficiency for Fede's Experiment
genotype_Fedepulldown <- c("KO", "WT", "WT2h")
Gapdh_Odd <- c(0.0701308,0.009137027,0.011952359)
Gapdh_Even <- c(0.045238763,0.004343471,0.043909272)
mTug1_Odd <-c(0.155516237,0.011414104,0.04585048)
mTug1_Even <-c(0.001099616, 8.29506E-05, 5.81551E-05)
mFirre_Odd <- c(0,70.40853578,11.74020811)
mFirre_Even <- c(0, 15.04682919, 15.4736664)
sd_fede <- c(0.062351006,0.009771398,0.010432933,0.048413036,0.003141753,0.066157591,0.167791558,0.019604462,0.063678141,0.001822,3.80322E-05, 4.01532E-05,0,42.54650799,20.03023555,0,14.13402302,0.786561053)

Fedepulldown_efficiency <- data.frame(genotype_Fedepulldown,Gapdh_Odd,Gapdh_Even, mTug1_Odd, mTug1_Even, mFirre_Odd, mFirre_Even)
mm_Fedepulldown <- melt(Fedepulldown_efficiency)
mm_Fedepulldown <- data.frame(mm_Fedepulldown,sd_fede)

pdf("/scratch/Shares/rinn/tenaya/ChChCh/2022_03_28_MassSpec_ChIRP_TVall//2022_05_02_Fede_FirreChIRP_PulldownEfficiency.pdf")
ggplot(mm_Fedepulldown, aes(x=variable, y=value, fill=genotype_Fedepulldown))+geom_bar(stat="identity", position=position_dodge())+ scale_fill_manual(values=c('#808080','#BB2526','#E63954'))+ ggtitle("In-House Firre ChIRP Pulldown Efficiency and Specificity Validated by RT-qPCR") +
  xlab("RNAs Tested by RT-qPCR Separated by Probe Set (Odd or Even)") + ylab("Relative Efficiency in Comparison to 2% Input") + geom_errorbar(aes(ymin=value-sd_fede, ymax=value+sd_fede), width=.2,
                 position=position_dodge(.9))+
  theme_minimal()
dev.off()
...
wtcheck_even_1outof6_JanTV_ChIRP <- dplyr::filter(wtcheck_1outof6_JanTV_ChIRP, wt_0h_even_total_intensity.Jan2022.Jan2022TV > 1)
wtcheck_odd_1outof6_JanTV_ChIRP <- dplyr::filter(wtcheck_1outof6_JanTV_ChIRP, wt_0h_odd_total_intensity.Jan2022.Jan2022TV > 1)
wtcheck_common_odd_even_1outof6_JanTV_ChIRP <- dplyr::filter(wtcheck_even_1outof6_JanTV_ChIRP, wt_0h_odd_total_intensity.Jan2022.Jan2022TV > 1)
...
wtcheckodd_1outof6_JanFede_ChIRP <- dplyr::filter(Intensities_Jan2022_FA, odd_wt_check.Fede_Jan2022 > 0)
wtcheckeven_1outof6_JanFede_ChIRP <- dplyr::filter(Intensities_Jan2022_FA, even_wt_check.Fede_Jan2022 > 0)
wtcheck_common_odd_even_1outof6_JaneFede_ChIRP <- dplyr::filter(wtcheckodd_1outof6_JanFede_ChIRP,  even_wt_check.Fede_Jan2022 > 0)
#ended up with 208 genes

#Now I want to look at only genes that went up from 0h to 2hWT 
...
#Venn Diagram Mar2022 and CommonOE of Fede
genes_Mar_v_Fede <- list(genes_kitMar2022 = sort(wtcheck_1outof6_Mar_ChIRP$gene.combinedMarChIRP), genes_Fede_commonOE = sort(wtcheck_common_odd_even_1outof6_JaneFede_ChIRP$gene.Fede_Jan2022) )
pdf("2022_04_26_VennDiagram_Mar_v_Fede_commonOE.pdf")
ggvenn(genes_Mar_v_Fede, c("genes_kitMar2022", "genes_Fede_commonOE"))
dev.off()
#by size
venn_win2 <- euler(c(KitChIRP_OE=384, CommonOE_Fede_ChIRP=49, "KitChIRP_OE&CommonOE_Fede_ChIRP"=133), shape = "ellipse")
pdf("2022_04_26_VennDiagram_Mar_v_Fede_commonOE_bysize.pdf")
plot(venn_win2, 
     fill = c("lightcoral", "darkslategray3"),
     quantities = list(fontsize = 13))
dev.off()

#Venn Diagram Mar2022 and CommonOE of JanTV
genes_Mar_v_JanTV <- list(genes_kitMar2022 = sort(wtcheck_1outof6_Mar_ChIRP$gene.combinedMarChIRP), genes_JanTV_commonOE = sort(wtcheck_common_odd_even_1outof6_JanTV_ChIRP$gene.Jan2022TV) )
pdf("2022_04_26_VennDiagram_Mar_v_JanTV_commonOE.pdf")
ggvenn(genes_Mar_v_JanTV, c("genes_kitMar2022", "genes_JanTV_commonOE"))
dev.off()
#by size
venn_win2 <- euler(c(KitChIRP_OE=457, CommonOE_JanTV_ChIRP=32, "KitChIRP_OE&CommonOE_JanTV_ChIRP"=60), shape = "ellipse")
pdf("2022_04_26_VennDiagram_Mar_v_JanTV_commonOE_bysize.pdf")
plot(venn_win2, 
     fill = c("lightcoral", "lightgoldenrod1"),
     quantities = list(fontsize = 13))
dev.off()

#Venn Diagram Even Fede and Even Jan 
genes_even_JanTV_v_JanFede <- list(evengenes_JanTV = sort(wtcheck_even_1outof6_JanTV_ChIRP$gene.Jan2022TV), evengenes_JanFede = sort(wtcheckeven_1outof6_JanFede_ChIRP$gene.Fede_Jan2022))
pdf("2022_04_26_VennDiagram_EvenGenes_JanTV_v_JanFede.pdf")
ggvenn(genes_even_JanTV_v_JanFede, c("evengenes_JanTV", "evengenes_JanFede"))
dev.off()
#by size
#by size
venn_win2 <- euler(c(evengenes_JanTV=55, evengenes_JanFede=143, "evengenes_JanTV&evengenes_JanFede"=41), shape = "ellipse")
pdf("2022_04_26_VennDiagram_EvenJanTV_v_JanFede_bysize.pdf")
plot(venn_win2, 
     fill = c("lightgoldenrod1", "darkslategray3"),
     quantities = list(fontsize = 13))
dev.off()

#Venn Diagram Odd JanTV and Odd JanFede
genes_odd_JanTV_v_JanFede <- list(oddgenes_JanTV = sort(wtcheck_odd_1outof6_JanTV_ChIRP$gene.Jan2022TV), oddgenes_JanFede = sort(wtcheckodd_1outof6_JanFede_ChIRP$gene.Fede_Jan2022))
pdf("2022_04_26_VennDiagram_OddGenes_JanTV_v_JanFede.pdf")
ggvenn(genes_odd_JanTV_v_JanFede, c("oddgenes_JanTV", "oddgenes_JanFede"))
dev.off()
#by size
#by size
venn_win2 <- euler(c(oddgenes_JanTV=64, oddgenes_JanFede=157, "oddgenes_JanTV&oddgenes_JanFede"=44), shape = "ellipse")
pdf("2022_04_26_VennDiagram_OddJanTV_v_JanFede_bysize.pdf")
plot(venn_win2, 
     fill = c("lightgoldenrod1", "darkslategray3"),
     quantities = list(fontsize = 13))
dev.off()

#For2hFede Use Sienna3

#Intersecting the data
genes_Mar_v_SucGrad <- list(genes_kitMar2022 = sort(wtcheck_1outof6_Mar_ChIRP$gene.combinedMarChIRP), genes_SucGrad= sort(wtcheck_1outof6_SucGrad$gene.combinedSucGrad), genes_Fede_commonOE = sort(wtcheck_common_odd_even_1outof6_JaneFede_ChIRP$gene.Fede_Jan2022))
pdf("2022_04_26_VennDiagram_Mar_v_SucGrad_v_commonOE_Fede.pdf")
ggvenn(genes_Mar_v_SucGrad, c("genes_kitMar2022", "genes_SucGrad", "genes_Fede_commonOE"))
dev.off()
#bysize
venn_win3 <- euler(c(MarTV=139, CommonOE_JanFede=1, SucGrad=3513, "MarTV&CommonOE_JanFede"=9, "MarTV&SucGrad"=245, "CommonOE_JanFede&SucGrad"=48, "MarTV&CommonOE_JanFede&SucGrad"=124), shape = "ellipse")
pdf("2022_04_26_VennDiagram_Mar_v_SucGrad_v_commonOE_Fede_bysize.pdf")
plot(venn_win3, 
     fill = c("lightcoral","darkslategray3", "white"),
     quantities = list(fontsize = 13))
dev.off()

```

#Making a spreadsheet of those 133 genes common between Jan2022Fede common genes (O+E) and Mar2022TV, 124 of which are common to SucGrad
```{r}
genes_MarTV_v_JanFede <- wtcheck_1outof6_Mar_ChIRP$gene.combinedMarChIRP[wtcheck_1outof6_Mar_ChIRP$gene.combinedMarChIRP %in% wtcheck_common_odd_even_1outof6_JaneFede_ChIRP$gene.Fede_Jan2022]
genes_MarTV_v_JanFede_v_SucGrad <- genes_MarTV_v_JanFede[genes_MarTV_v_JanFede %in% wtcheck_1outof6_SucGrad$gene.combinedSucGrad]
length(genes_MarTV_v_JanFede)
length(genes_MarTV_v_JanFede_v_SucGrad)

pattern_to_searchZ <- paste0(genes_MarTV_v_JanFede, collapse = "$|^")
pattern_to_search20 <- paste("^",pattern_to_searchZ,"$",sep="")
subset1 <- wtcheck_1outof6_Mar_ChIRP[grepl(pattern_to_search20, wtcheck_1outof6_Mar_ChIRP$gene.combinedMarChIRP),]
subset2 <- wtcheck_common_odd_even_1outof6_JaneFede_ChIRP[grepl(pattern_to_search20, wtcheck_common_odd_even_1outof6_JaneFede_ChIRP$gene.Fede_Jan2022),]
compositedata_genes_MarTV_v_JanFede <- inner_join(subset1, subset2, by = c("gene.combinedMarChIRP" = "gene.Fede_Jan2022"))

#SucGrad
subset3 <- wtcheck_1outof6_SucGrad[grepl(pattern_to_search20, wtcheck_1outof6_SucGrad$gene.combinedSucGrad),]
composite_data_genes_MarTV_v_JanFede_v_SucGrad <- full_join(compositedata_genes_MarTV_v_JanFede, subset3, by = c("gene.combinedMarChIRP" = "gene.combinedSucGrad"))
write.csv(composite_data_genes_MarTV_v_JanFede_v_SucGrad, file = "2022_05_09_compositedata_genes_OEJanFede_Mar2022_SucGrad.csv", row.names=TRUE)
```

#Doing venn diagram and also spreadsheets of all genes common to Jan2022Fede, Mar2022TV, and SucGrad with ratios above 1.5
```{r}
#Doing a 2h fold change over wt fold change for Fede Jan data 
wtcheck_1outof6_JanFede_ChIRP$odd_2hfc_wtfc_ratio = wtcheck_1outof6_JanFede_ChIRP$odd_2h_wt_ratio.Fede_Jan2022/wtcheck_1outof6_JanFede_ChIRP$odd_wt_ratio.Fede_Jan2022
wt_odd_1.5_2h_ratiocheck_wtcheck_1outof6_JanFede_ChIRP<- dplyr::filter(wtcheck_1outof6_JanFede_ChIRP, odd_2hfc_wtfc_ratio >= 1.5)

wtcheck_1outof6_JanFede_ChIRP$even_2hfc_wtfc_ratio = wtcheck_1outof6_JanFede_ChIRP$even_2h_wt_ratio.Fede_Jan2022/wtcheck_1outof6_JanFede_ChIRP$even_wt_ratio.Fede_Jan2022
wt_even_1.5_2h_ratiocheck_wtcheck_1outof6_JanFede_ChIRP<- dplyr::filter(wtcheck_1outof6_JanFede_ChIRP, even_2hfc_wtfc_ratio >= 1.5)

#1.5-ratio cutoff for MarChIRP combined data
ratiofiltered_Mar2022ChIRPcombined <- dplyr::filter(wtcheck_1outof6_Mar_ChIRP, ratio.combinedMarChIRP >= 1.5) 

#Venn Diagram 

#Intersecting the data
genes_Fede_1.5_2hfc_wtfc_ratio <- list(genes_oddInHouse = sort(wt_even_1.5_2h_ratiocheck_wtcheck_1outof6_JanFede_ChIRP$gene.Fede_Jan2022), genes_evenInHouse= sort(wt_odd_1.5_2h_ratiocheck_wtcheck_1outof6_JanFede_ChIRP$gene.Fede_Jan2022), genes_kitMar2022 = sort(ratiofiltered_Mar2022ChIRPcombined$gene.combinedMarChIRP))
pdf("2022_05_23_VennDiagram_JanFede_1.5_2hfc_wtfc_ratio.pdf")
ggvenn(genes_Fede_1.5_2hfc_wtfc_ratio, c("genes_oddInHouse","genes_evenInHouse","genes_kitMar2022"))
dev.off()
#bysize
venn_win_jan_ratio_fc <- euler(c(KitCombined=303, InHouse_Odd=50, InHouse_Even=13, "KitCombined&InHouse_Odd"=12, "KitCombined&InHouse_Even"=1, "InHouse_Odd&InHouse_Even"=5, "KitCombined&InHouse_Odd&InHouse_Even"=0), shape = "ellipse")
pdf("2022_05_23_VennDiagram_JanFede_1.5_2hfc_wtfc_ratio_bysize.pdf")
plot(venn_win_jan_ratio_fc, 
     fill = c("lightcoral","darkslategray3", "white"),
     quantities = list(fontsize = 13))
dev.off()

#Regular 1.5-ratio cutoff for odd and even WT
wt_odd_reg_ratiocheck_wtcheck_1outof6_JanFede_ChIRP<- dplyr::filter(wtcheck_1outof6_JanFede_ChIRP, odd_wt_ratio.Fede_Jan2022 >= 1.5)
wt_even_reg_ratiocheck_wtcheck_1outof6_JanFede_ChIRP<- dplyr::filter(wtcheck_1outof6_JanFede_ChIRP, even_wt_ratio.Fede_Jan2022 >= 1.5)

genes_FedeO_E_Marcomb_ratio <- list(genes_oddInHouse = sort(wt_odd_reg_ratiocheck_wtcheck_1outof6_JanFede_ChIRP$gene.Fede_Jan2022), genes_evenInHouse= sort(wt_even_reg_ratiocheck_wtcheck_1outof6_JanFede_ChIRP$gene.Fede_Jan2022), genes_kitMar2022 = sort(ratiofiltered_Mar2022ChIRPcombined$gene.combinedMarChIRP))
pdf("2022_05_23_VennDiagram_JanFede_reg_ratio_MarChIRP.pdf")
ggvenn(genes_FedeO_E_Marcomb_ratio , c("genes_oddInHouse","genes_evenInHouse","genes_kitMar2022"))
dev.off()
```
