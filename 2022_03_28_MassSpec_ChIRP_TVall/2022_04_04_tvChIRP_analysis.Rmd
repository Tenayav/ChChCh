...
Intensities2_filteroutinput_nonzero$wt_mean <- rowMeans(subset(Intensities_sucgrad_nonzero, select = c(r2_wt_oe_intensity.50ng, r3_wt_oe_intensity.50ng, r4_wt_oe_intensity.50ng, r2_wt_oe_intensity.100ng, r3_wt_oe_intensity.100ng, r4_wt_oe_intensity.100ng)),)
Intensities2_filteroutinput_nonzero$ko_mean <- rowMeans(subset(Intensities_sucgrad_nonzero, select = c(r2_ko_oe_intensity.50ng, r3_ko_oe_intensity.50ng, r2_ko_oe_intensity.100ng, r3_ko_oe_intensity.100ng)),)
Intensities2_filteroutinput_nonzero <- Intensities_sucgrad_nonzero %>% mutate(ratio = wt_mean/ko_mean)
...
hist(Intensities2_filteroutinput_nonzero$logratio, breaks = 20, main="Frequency of Log (10) WT: KO Ratio \n of Mass Spec Intensities from Sucrose Gradient Fractions 5 and 6", xlab = "Log (10) Ratio of WT: KO Intensities", ylab = "Frequency of Genes", labels=TRUE)
dev.off()
