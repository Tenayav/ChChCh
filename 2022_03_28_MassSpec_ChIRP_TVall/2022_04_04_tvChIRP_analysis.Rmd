...
Intensities_A <- Intensities %>% replace_na(list(r2_ko_oe_intensity.50ng = 0,r2_wt_oe_intensity.50ng = 0, r3_ko_oe_intensity.50ng = 0, r3_wt_oe_intensity.50ng = 0, r4_ko_oe_intensity.50ng=0, r4_wt_oe_intensity.50ng=0, r2_ko_oe_intensity.100ng=0, r2_wt_oe_intensity.100ng=0, r3_ko_oe_intensity.100ng=0, r3_wt_oe_intensity.100ng=0, r4_wt_oe_intensity.100ng=0)) 
...
Intensities_with_Jan2022 <- 

#
Intensities2 <- Intensities_A
Intensities_2 <- Intensities2 %>% map_if(is.numeric, ~.+1)




Intensities_2 <- Intensities_2 %>% mutate(intensities_ratio1 = (r2_wt_oe_intensity.50ng/r2_ko_oe_intensity.50ng), intensities_ratio2=(r3_wt_oe_intensity.50ng/r3_ko_oe_intensity.50ng), intensities_ratio3 = (r4_ko_oe_intensity.50ng/mean(c())))
summary(Intensities_2$intensities_sum)
