...
hist(wtcheck_1outof6_Mar_ChIRP$ttest_pvalue.combinedMarChIRP, breaks = 50, main="(1 out of 6) Frequency of T-Test P-values in Mar2022 ChIRP Data", xlab = "T-Test P-value", ylab = "Frequency of P-values", labels=TRUE) 
dev.off()
...
hist(wtcheck_1outof6_Mar_ChIRP$wilcoxtest_pvalue.combinedMarChIRP, breaks = 50, main="(1 out of 6) Frequency of Wilcox P-values in Mar2022 ChIRP Data", xlab = "Wilcox P-value", ylab = "Frequency of P-values", labels=TRUE) 
dev.off()
...
wtcheck_1outof6_JanTV_ChIRP <- dplyr::filter(Intensities_Jan2022_FA, wt_check.Jan2022TV > 0)
