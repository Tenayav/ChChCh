...
##For later, transpose the tibble
#WT_intensities <- as.data.frame(t(WT_intensities))

Gene_names <- tibble(KO_spectral$Gene)
Gene_names <- Gene_names[-c(297:305),] 
```

#Making each protein its own tibble.
```{r}
