...
ggplot(mm_sigIntensities5)+geom_boxplot(aes(x=genotype, y=value),fill = "#BB2526")+facet_grid(.~variable)+stat_compare_means(aes(x=genotype, y=value,group = genotype),label = "p.format")+ggtitle("Mass Spec Intensities of 5 Genes of Interest")+labs(y = "Mass Spec Intensity", x = "\nFirre Genotype in Mouse Embryonic Stem Cells")
dev.off()
```
