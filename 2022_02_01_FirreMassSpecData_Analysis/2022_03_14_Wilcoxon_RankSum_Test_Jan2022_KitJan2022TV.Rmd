...
#For allgenes, I'm going to do those box-whisker plots 
```{r}
#Common genes
...
ggplot(mm_Spectral)+geom_boxplot(aes(x=genotype, y=value))+facet_grid(.~variable)
dev.off()
...
for (var in mm_commonSpectral$variable) { 
  ...
  print(ggplot(mm_commonSpectral[mm_commonSpectral$variable==var,])+geom_boxplot(aes(x=genotype, y=value))+ggtitle(var))
  dev.off()
  }
