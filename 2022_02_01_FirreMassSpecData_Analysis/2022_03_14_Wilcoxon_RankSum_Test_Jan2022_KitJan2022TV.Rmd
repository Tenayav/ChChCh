...
ggplot(mm_sigSpectral)+geom_boxplot(aes(x=genotype, y=value))+facet_grid(.~variable)
dev.off()
...
for (var in mm_sigSpectral$variable) { 
  ...
  print(ggplot(mm_sigSpectral[mm_sigSpectral$variable==var,])+geom_boxplot(aes(x=genotype, y=value))+ggtitle(var))
  dev.off()
  }
...
ggplot(mm_sigIntensities)+geom_boxplot(aes(x=genotype, y=value))+facet_grid(.~variable)
dev.off()
...
for (var in mm_sigIntensities$variable) { 
  ...
  print(ggplot(mm_sigIntensities[mm_sigIntensities$variable==var,])+geom_boxplot(aes(x=genotype, y=value))+ggtitle(var))
  dev.off()
  }
```
