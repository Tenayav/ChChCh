...
##Boxplot
```{r}
bxp <- ggboxplot(data_long, x = "Expt", y = "Spectral_Count",
         ylab = "Spectral Count", xlab = "Genotype", add = "jitter")
bxp
```

##Distribution Check (Remnant from Willcoxon Signed Rank TestTa)
```{r}
#data <- data %>% mutate(differences = wt - ko)
#gghistogram(data, x = "differences", y = "..density..", fill = "steelblue",bins = 15, add_density = TRUE)
